  ...
  return (
    <Container className="my-5" style={{ maxWidth: 600 }}>
      <Card className="shadow-lg p-4 rounded-4">
        ...
        <p className="fw-bold">
         Total Price: <span className="text-success">${sub.totalPrice}</span>
        </p>
        ...
        <p>
          End date: <strong>{new Date(sub.endDate).toLocaleDateString()}</strong>
        </p>
        ...
        >
          Status: {sub.isExpired ? "Deactive" : "Active"}
        </p>
      </Card>
    </Container>
